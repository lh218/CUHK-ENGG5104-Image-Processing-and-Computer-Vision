...
if __name__ == '__main__':
    ...
    d, sigmaColor, sigmaSpace = 15, 80, 80
    ...
    result_diff = cv2.addWeighted(result_bilateral, -1, result_joint_bilateral, 1, 0)
    
    cv2.imwrite('./results/Billateral.jpg', result_bilateral)
    cv2.imwrite('./results/JointBillateral.jpg', result_joint_bilateral)
    cv2.imwrite('./results/DiffBillateral.jpg', result_diff)