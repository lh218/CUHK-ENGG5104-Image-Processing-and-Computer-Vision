...
if __name__ == '__main__':
    ...
    # image1 = cv2.imread('../data/Episcopal/img1.jpg').astype('single')
    # image2 = cv2.imread('../data/Episcopal/img2.jpg').astype('single')
    # eval_file = '../data/Episcopal/img1_to_img2.npy'
